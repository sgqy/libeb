...
/*
 * VC++ implecitly includes <ctype.h>, but that causes an comiple error
 * since we redefine ctype macros such as isalpha(). The definition of
 * _CTYPE_DEFINED below avoids the problem.
 */
